...
- ~~이후 앨범에서 사진을 **수정/삭제**해도 포스팅했던 이미지는 **변동 없음**!
	(진짜 좋다..ㅎㅎ)~~
	- (나중에 추가한 내용1) 이후 이미지가 또 안 떴는데, 앨범에 들어가 우측 상단의 ```점 세개 아이콘``` - ```옵션``` - ```링크 공유``` 설정한 후 다시 이미지가 나왔음. 이거 해 줘야 함...ㅎㅎ 🙃
	- (나중에 추가한 내용2) 함부로 삭제하지 말자. 얘가 나중에 또 어떤 말썽을 피울지 몰라...스택에딧 익숙해지기 전까지는 진짜 조심..
...
#### -2021.06.22-
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTE0MTExNzM2LC04OTY3NjYwODMsLTEyNj
E4NTQ3NjYsMjEzODg5NTA4NSwtMjEwNjM1NTAyNywtNDUyODk1
MDA1LDk0MTAxMzQxMiw3ODI0MTM3OCw2MzU5OTI1ODEsLTEwMT
